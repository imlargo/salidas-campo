<script lang="ts">
	...
	import RowProyeccion from './ProyeccionUab.svelte';
...
<div class="grid grid-cols-4 sm:grid-cols-9 md:font-semibold gap-x-5 font-semibold">
	<span class="text-center hidden sm:block">Consecutivo</span>
	<span class="hidden sm:block">Asignar</span>
