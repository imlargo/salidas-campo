...
<Section titulo="Información Asignatura">
	...
	<div class="field-layout grid-cols-2">
		<div>
			<label class="form-label">Número del grupo(s)</label>
			<input
				id="grupo"
...
<Section titulo="Información de la salida y regreso">
	<div class="field-layout grid-cols-3">
		<div>
			<label class="form-label">Fecha (Día/Mes/Año)</label>
			<input
				required
				class="form-control"
				type="date"
	...
	<div>
		<label class="form-label">Duracion (Cantidad de días)</label>
		<input
			required
			readonly
			type="number"
...
<Section titulo="Destino más lejano">
	<div>
		...
		<select required class="form-control" id="ultimoDestino" name="ultimoDestino">
			<option value="" disabled>--- Seleccionar ---</option>
